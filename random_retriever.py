...
class RandomFinder:
    def __init__(self, cfg: DictConfig) -> None:
        ...
        self.dataset_wrapper = get_dataset_wrapper(cfg.task_name, dataset_split=cfg.dataset_split, ds_size=cfg.ds_size, lang_name=cfg.lang_name, high_lang_name=cfg.high_lang_name, all_data=cfg.all_data,test_lang_name=cfg.test_lang_name)
